...
public class OrderViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public TextView day_Date_TxtVw, payment_Status_TxtVw, order_Id_TxtVw, amount_TxtVw , items_TxtVw, order_Status_TxtVw, order_Status_Dot_TxtVw;
    public View dot_Vw;
    ...
    public OrderViewHolder(@NonNull View itemView) {
        ...
        payment_Status_TxtVw = itemView.findViewById(R.id.payment_Status_Active_Orders);
