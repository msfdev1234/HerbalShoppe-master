...
public class CodeVerificationActivity extends AppCompatActivity {
   private String phoneNumber, verificationId, name, activityFrom, countryCodePhoneNumber, countryCode;
   ...
   private LoadingDialog loadingDialog;
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    if (activityFrom.equals("signUp")){
                        ...
                        updateDataBase(phoneNumber, name, countryCode);
                        ...
                        Paper.book().write(Prevalent.UserPhoneKey,countryCode+phoneNumber);
    ...
    private void updateDataBase(final String phoneNumber, String name, final String countryCode) {
        ...
        RootRef.child("Users1").child(countryCode+phoneNumber).updateChildren(userDataMap)
